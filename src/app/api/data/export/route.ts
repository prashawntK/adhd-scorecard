...
export const GET = withApiHandler(async () => {
  const [goals, dailyLogs, timerSessions, streaks, dailyScores, rewards, journal, energy, extraCurriculars, extraCurricularLogs, chores, choreTimeLogs, choreCompletionLogs] =
    await Promise.all([
